<x-layout>
    ...
    <div class="container background-container bg-dark vh-100">
                ...
                <div class="row card-home justify-content-start mb-5">
                    ...
                    <div class="col-6 d-flex flex-column justify-content-center ">
                        ...
                        <div class="d-flex justify-content-end">
                            <a href="{{route('articles.category', $article->category)}}" class="btn btn-primary me-3">{{$article->category->name}}</a>
